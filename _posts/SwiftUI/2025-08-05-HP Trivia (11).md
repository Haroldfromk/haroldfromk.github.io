...
![image](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/fd199a01-44f0-4181-a046-59b954c8cf5b.png){: width="50%" height="50%"}

* `Next`를 누르면 나타나는 팀 설정 창은 지금 단계에서는 체크하지 않고 넘어가도 무방하다.
![image](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/42646c7f-6e09-4d04-8d97-03726ca09c16.png){: width="50%" height="50%"}

### 2. 결제 상품(Product) 추가

파일이 생성되면 좌측 하단의 `+` 버튼을 눌러 결제 항목을 추가한다.

![image](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/2aed12f8-5279-4d21-9080-d4fc70c10c4f.png){: width="50%" height="50%"}
![image](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/d3092137-e396-4a26-aa4c-9e46d23436a8.png){: width="50%" height="50%"}

우리는 한 번 결제하면 영구적으로 유지되는 **Non-Consumable(비소모품)** 유형을 선택한다.

<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/bb443d64-0d50-490a-b3b7-d68d9ef47e1d.png" />

* **Reference Name**: HP4
* **Product ID**: hp4

하단의 `Localizations` 섹션을 더블 클릭하여 사용자에게 보일 상품 정보를 입력한다.
<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/d17f1d08-3b2d-49f0-a131-2c6efacf94a2.png" />

### 3. 상품 복사 및 확장

HP4부터 HP7까지 여러 상품이 필요하므로, 기존 항목을 `Copy & Paste`하여 빠르게 생성한다. 생성 후 `Product ID`와 `Localizations` 정보를 각 상품에 맞게 수정한다.

<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/c794e60f-70a9-448e-9058-446ce6fe3a42.png" />

### 4. Edit Scheme 설정 적용

설정 파일을 만든 것만으로는 부족하다. Xcode의 **Scheme** 설정을 변경하여 앱 실행 시 해당 StoreKit 파일을 참조하도록 지정해야 한다.

<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/9cb2575a-ed40-416b-bbcc-ccbaab7f97e9.png" />

* `None`으로 되어 있는 StoreKit Configuration 항목을 방금 만든 파일로 변경한다.

<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/7793c794-41ec-49f1-9a90-1bc84783b793.png" />
<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/513106ff-d3fb-421a-9093-be614771a24d.png" />
...
<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/cc4f0a9b-5608-444d-8541-bd620a74e350.png" />
...
![image](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/c0965a17-ccda-4146-977b-f2c6ed8cfc44.png){: width="50%" height="50%"}
...
<img width="50%" height="50%" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/1cb1ea7b-67aa-4b09-bb3e-dad26493dbed.png" />
...
2. **데이터 타입 분석**
   ...
   - <img width="589" height="232" alt="Image" src="https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2025-08-05-HP-Trivia-11/d3174a81-2718-4565-a1b8-fc300fbc13a3.png" />
