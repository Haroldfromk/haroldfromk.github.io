...
사실 Concurrency는 개인적으로 Swift에서 아주 중요하다고 생각 [이전글](https://haroldfromk.github.io/udemy/concurrency/Async_await-(1)/){:target="_blank"}은 여기
...
여기서 잠깐 정리를 해보자면,
(물론 [이전글](https://haroldfromk.github.io/udemy/concurrency/Async_await-(2)/){:target="_blank"}에서 다뤘지만 remind겸 여기에도 적으면 좋으니 정리.)
...
try는 [이전글](https://haroldfromk.github.io/%EC%BA%A0%ED%94%84/2%EC%A3%BC%EC%B0%A8/Main-campus_2nd-week-5/){:target="_blank"}참고
...
그리고 Compact는 [이전글](https://haroldfromk.github.io/deep%20dive/High-order-function/){:target="_blank"}확인
