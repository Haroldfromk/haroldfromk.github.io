    ...
    - cell을 하나 만들어주면
        - tableView.dequeueReusableCell 메서드를 사용하게된다.
            - withIdentifier : 아래 사진을 의미한다. 
                - ![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/SDC7OkWKNh.png){: width="50%" height="50%"}

여기까지 작성한걸 확인해보자.

![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/p2fJxoRQ5J.png){: width="50%" height="50%"}
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/0A9P8Kxl6u.png){: width="50%" height="50%"}
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/buG3E2w0D1.png){: width="50%" height="50%"}

잘 나온다.

그런데 일반적으로 tableView라면 구분선이 있는데 보이지가 않는다?

![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/YTT8IfqcGV.png){: width="50%" height="50%"}
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/vI2Aje7Zhl.gif){: width="50%" height="50%"}
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/IrbiXMa2UC.png){: width="50%" height="50%"}

이제는 실행해도 해당부분을 클릭하면 회색으로 보이지 않는다.

![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-19-FlashChat-5/PQjRPGAAM9.gif){: width="50%" height="50%"}