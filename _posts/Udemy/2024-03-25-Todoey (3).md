...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/ZnGPoE4uAk.png){: width="50%" height="50%"}
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/w9S3byuImB.png){: width="50%" height="50%"}

![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/gBtDSarzwe.png)
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/KLw8KkpPZ8.png){: width="50%" height="50%"}

그리고 아래와 같이 Optional로 할지 안할지도 설정이 가능하다.

![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/QkaAloe9R2.png){: width="50%" height="50%"}

이렇게 Attributes를 만들었다면.

Item.swift파일은 지워주자.

그리고 코어 데이터가 복잡해지면 (멀티 스레딩이 필요하다면) ![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/96iiZREk1N.png){: width="50%" height="50%"} 해당부분으로 사용하지 않으면 에러가 발생 할 수 있으므로, 모듈도 꼭 세팅해주자.
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/DhechmKmzi.png)
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/tZ5jdNSJlx.png){: width="50%" height="50%"}
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/GEeSAHNQZR.png){: width="50%" height="50%"}

sqlite파일을 열수있는 프로그램을 설치하면 볼 수 있는데, 난 DB Browser for SQLite 라는 앱을 사용했다.

데이터를 보면?

![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/M3lxmtyoRh.png){: width="50%" height="50%"}

![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/6XPpfW2l0J.gif)
...
![](https://pub-1fd8ca6711bd4f3f8b74d88a697b50f9.r2.dev/2024-03-25-Todoey-3/FZuL5CYfav.png){: width="50%" height="50%"}
