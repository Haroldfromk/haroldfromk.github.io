...
![CleanShot 2024-12-06 at 17 06 03](https://github.com/user-attachments/assets/d5a06837-8346-48cc-aa94-6bd4dd8758ec){: width="50%" height="50%"} 그럼 이렇게 만들어진다.
...
현재 달의 시작 날짜와 끝 날짜를 전부를 가져오게 된다.
...
2. days.count < 10
	...
	- 이 로직은 일반적으로 앞뒤 월의 접두사 또는 접미사 날짜(prefix, suffix days)만 저장된 경우를 처리하기 위한 것이다.
...
![CleanShot 2024-12-06 at 18 20 04](https://github.com/user-attachments/assets/57e13aa7-3c42-4b24-ba85-d1269d934cc3)
