# [Project] FlightLog: The Aviator's Running Tracker (Master Plan v2.1)
...
- **Dynamic Island HUD**: `WidgetKit`을 활용해 백그라운드 운항 상태 모니터링
...
| **Extension** | **WidgetKit** | 홈 화면 위젯 및 Live Activities(HUD) 구현 |
